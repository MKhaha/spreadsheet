...
void MainWindow::scanWorkPiece()
{
    ...
    scanWorkPieceDialog->activateWindow();
}

void MainWindow::setDatabaseAndTable()
{
...
void MainWindow::createActions()
{
    ...
    scanWorkPieceAction = new QAction(tr("Scan work piece"), this);
    scanWorkPieceAction->setStatusTip(tr("scan work piece"));
    scanWorkPieceAction->setShortcut(tr("F10"));
    connect(scanWorkPieceAction, SIGNAL(triggered()),
            this, SLOT(scanWorkPiece()));

    setDatabaseAndTableAction = new QAction(tr("set database name and table"), this);
    setDatabaseAndTableAction->setStatusTip(tr("set database name and table"));
    setDatabaseAndTableAction->setShortcut(tr("F11"));
